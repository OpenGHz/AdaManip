...
class OpenCoffeeMachine(BaseEnv):
    ...
    def get_adjust_hand_pose(self):
        ...
        # 0.7071068, 0, 0, 0.7071068 0, -0.7071068, 0.7071068, 0  0.7071068, 0.7071068, 0, 0
    ...
    def _obj_init_pose(self, min_dict, max_dict, name):
        ...
        if name == "cm_1":
            height = 0.25
        elif name == "cm_3" or name == "cm_8" or name == "cm_7":
            height = 0.35
