...
class OpenWindow(BaseEnv):
    ...
    def _franka_init_pose(self):
        ...
        initial_franka_pose.p = gymapi.Vec3(0.68, 0.0, 0.1)
    ...
    def get_adjust_hand_pose(self):
        ...
        down_q = torch.stack(self.num_envs * [torch.tensor([0.7071068, 0.7071068, 0.0, 0])]).to(self.device).view((self.num_envs, 4))
    ...
    def init_obj_dof_state(self, env_id):
        ...
        if self.task in ("open_window", "open_window_one_go"):
